...
class Teacher(models.Model):
    ...
    stavka_budget = models.FloatField(verbose_name='Ставка бюджет', blank=True, null=True)
    stavka_ochnoe = models.FloatField(verbose_name='Ставка', blank=True, null=True)
...
class Connect(models.Model):
    ...
    ped_staj = models.IntegerField(default=0, verbose_name='Пед стаж')
    shtat_sovmest = models.CharField(max_length=250, verbose_name='Штат.или совмест.', blank=True, null=True)
    shtat_edinicy_budget = models.FloatField(verbose_name='Штатные единицы / бюджет', blank=True, null=True)
    shtat_edinicy_kontrakt_zaochnoe = models.FloatField(verbose_name='Штатные единицы / контракт / заочное', blank=True, null=True)
    shtat_edinicy_vsego = models.FloatField(verbose_name='Штатные единицы / всего', blank=True, null=True)
    ucheb_nagruzka_budget = models.FloatField(verbose_name='Учебная нагрузка / бюджет', blank=True, null=True)
    ucheb_nagruzka_kontract_ochnoe = models.FloatField(verbose_name='Учебная нагрузка / контракт / очное', blank=True, null=True)
    ucheb_nagruzka_kontract_zaochnoe = models.FloatField(verbose_name='Учебная нагрузка / контракт / заочное', blank=True, null=True)
    ucheb_nagruzka_Vsego = models.FloatField(verbose_name='Учебная нагрузка / Всего', blank=True, null=True)
