...
class Groupp(models.Model):
    ...
    rukovod_KRIKP = models.FloatField(verbose_name='Руковод.КРиКП', blank=True, null=True, default=0)
    recenzirov_KR = models.FloatField(verbose_name='Рецениров_КР', blank=True, null=True, default=0)
